...
type CommitAck struct {
	...
	Id        uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`              // the replica's ID
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"` // the replica's signature
	CmdHash   []byte `protobuf:"bytes,3,opt,name=cmdHash,proto3" json:"cmdHash,omitempty"`     // The hash of the command that is being acknowledged
}
...
func (x *CommitAck) GetCmdHash() []byte {
	if x != nil {
		return x.CmdHash
	}
	return nil
...
var file_msg_clientAck_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x53, 0x0a, 0x09, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x41, 0x63, 0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6d, 0x64, 0x48, 0x61, 0x73, 0x68,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x6d, 0x64, 0x48, 0x61, 0x73, 0x68, 0x42,
