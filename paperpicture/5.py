...
filepath = '/root/Reputation-based-state-machine-replication-/paperpicture'
fig_name = 'scatterplot5.pdf'
fig_path = filepath + '/' + fig_name
# Create a visualization
# 加载数据
flights=pd.read_csv('sa5.csv')
flights.head()
# 长型数据多折线图
...
errorbar=None,hue='Misbehaviour',style='Misbehaviour',markers=['s','o','h','H','^'] ,linewidth = 0.6,
orient='x', markeredgecolor = 'none',alpha = 0.6)
#alpha 设置透明度
#mark空心，mark见matlop
#markerfacecolor='none'
fig.set_xlim(1,70) 
fig.set_ylim(4000,6500)
#设置x,y轴label大小
