...
fig_name = 'tpsnodenumnew.svg'
fig_path = filepath + '/' + fig_name
# Create a visualization
# 加载数据
flights=pd.read_csv('sa32.csv')
flights.head()
# 长型数据多折线图
...
fig = sns.lineplot(data=flights,x='路侧单元数量',y='吞吐量/tps',dashes=False,sort=True,
errorbar=None,hue='共识协议',style='共识协议',markers=['^','D','v'] ,linewidth = 1.5,
orient='x', markeredgecolor = 'none',alpha = 1)
#alpha 设置透明度
#mark空心，mark见matlop
...
# lineplot_figure.savefig("3.2.svg", format="svg" ,dpi = 1000)
# plt.show()
